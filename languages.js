...
"ab":["Abkhazian","Аҧсшәа"],
"ace":["Achinese","Acèh"],
"ady":["Adyghe","Адыгэбзэ / Adygabze"],
"aeb":["Tunisian Spoken Arabic","زَوُن"],
"af":["Afrikaans","Afrikaans"],
"ak":["Akan","Akan"],
"akz":["Albaamo innaaɬiilka","Albaamo innaaɬiilka"],
...
"aro":["Araona","Araona"],
"arq":["Algerian Spoken Arabic","Dziri"],
...
"bbc":["Batak Toba/Batak autonym unknown","Batak Toba/Batak autonym unknown"],
...
"bn":["Bengali","বাংলা"],
"bo":["Tibetan","བོད་ཡིག"],
"bpy":["Bishnupria Manipuri","বিষ্ণুপ্রিয়া মণিপুরী"],
...
"glk":["Gilaki","گیلکی"],
"gn":["Guarani","Avañe'ẽ"],
"gom":["Goan Konkani","कोंकणी/Konknni"],
"got":["Gothic","Gothic"],
...
"mwv":["Behase Mentawei","Behase Mentawei"],
"my":["Burmese","မြန်မာဘာသာ"],
"myv":["Erzya","эрзянь"],
"mzn":["Mazanderani","مازِرونی"],
"nah":["Nahuatl","Nāhuatl"],
"nan":["Min Nan Chinese","Bân"],
...
"qug":["Runa shimi","Runa shimi"],
"rap":["Rapanui","arero rapa nui"],
...
"sah":["Sakha","саха тыла"],
"sat":["Santali","Santali"],
"saz":["ꢱꣃꢬꢵꢯ꣄ꢡ꣄ꢬꢵ","ꢱꣃꢬꢵꢯ꣄ꢡ꣄ꢬꢵ"],
"sc":["Sardinian","sardu"],
"scn":["Sicilian","sicilianu"],
"sco":["Scots","Scots"],
"sd":["Sindhi","سنڌي"],
"sdc":["Sassaresu","Sassaresu"],
"se":["Northern Sami","sámegiella"],
"sei":["Cmique Itom","Cmique Itom"],
"sg":["Sango","Sängö"],
...
"sly":["Bahasa Selayar","Bahasa Selayar"],
...
"tkr":["ЦӀаьхна миз","ЦӀаьхна миз"],
"tl":["Tagalog","Tagalog"],
"tly":["толышә зывон","толышә зывон"],
"tn":["Tswana","Setswana"],
"to":["Tongan","lea faka"],
